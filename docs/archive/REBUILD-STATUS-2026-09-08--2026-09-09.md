# Rebuild-status archive: 2026-09-08 to 2026-09-09

`make verify` entries moved verbatim out of `REBUILD-STATUS.md`, which now
carries only the newest runs and the tier definitions. The next period is
`REBUILD-STATUS-2026-09-14--2026-09-15.md`.
