# PROGRESS archive: 2026-09-06 to 2026-09-12

Entries moved verbatim out of `PROGRESS.md`, which now carries only the
current line of work. The next period is
`PROGRESS-2026-09-13--2026-09-19.md`. The project-baseline overview that
used to open `PROGRESS.md` is the first section below; for the current
state read `README.md` and `docs/` instead.
