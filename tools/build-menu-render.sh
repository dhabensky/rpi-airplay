...
#
# Usage: tools/build-menu-render.sh [output-dir]   (default: build/bin)
...
# otherwise survive the run and pass the artifact check below unnoticed.
rm -f "$outdir_abs/menu-render"
