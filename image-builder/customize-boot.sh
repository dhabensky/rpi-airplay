...
echo "==> Keeping 'console=tty1' in cmdline.txt: the boot log needs to render"
echo "    somewhere for debugging. zero-fb0-late.service re-zeros /dev/fb0"
...
echo "    disables just the cursor, not boot text)"
